namespace MyContosoDemo.Migrations
{
    using System;
    ...
    public partial class m1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Person", t => t.Instructor_ID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.InstructorCourse", "Instructor_ID", "dbo.Person");
